...
local Window = Library.CreateLib("Magic Hub Main", "GrapeTheme")

local Misc = Window:NewTab("Info")
local Section = Misc:NewSection("Made By Cristimagi")

local Misc = Window:NewTab("Scripts")
local Section = Misc:NewSection("Made By Cristimagi")

Section:NewButton("InfiniteYeld", "Run InfiniteYeld", function()
    loadstring(game:HttpGet(('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'),true))()
end)
Section:NewButton("aimbot", "iti fuge tinta", function()
    --[[
...
Section:NewButton("Run & Speed", "fugi si sari tare dupa gusturile tale", function()
